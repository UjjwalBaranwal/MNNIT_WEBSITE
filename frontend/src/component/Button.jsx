  ...
  //  console.log(rest.className);
    const classes = twMerge(
        className('flex items-center px-3 py-1.5 border my-1 mx-1', {
          'border-cyan-500 bg-cyan-500 text-white hover:bg-cyan-600 focus:ring-2 focus:ring-cyan-700...': primary,
          ...
          'text-cyan-500 hover:text-white focus:ring-2 focus:ring-cyan-700 ...': outline && primary,
